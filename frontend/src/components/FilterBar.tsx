      ...
      <div className="flex flex-col md:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end flex-wrap">
          <div className="flex items-center gap-2">
            ...
            >
              <option value="">Wszystkie rodzaje transportu</option>
              <option value="flight">✈️ Przelot samolotem</option>
              <option value="self_transport">🚗 Dojazd własny</option>
              <option value="bus">🚌 Autokar</option>
              <option value="train">🚆 Pociąg</option>
              <option value="cruise">🚢 Rejs</option>
            </select>
            ...
            >
              ...
              <option value="travel_score">Deal Score (najwyższy)</option>
